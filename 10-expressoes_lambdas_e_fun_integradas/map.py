...
- Map é uma função que receve 02 parametros: O prineiro (FUNÇÃO) e o Segundo (ITERAVEL).
...
''''Apos utilizar a função 'map()' - contida na variavel areas_2, depois da primeira utilização do ressultado 
(print(list(areas_2)), ele zera.'''
...
print('Olá você esta no arquivo Map()')