...
dir -> Apresenta todos os atributos/propriedades e funções/métodos disponiveis para determinado tipo de dado o variavel.
    Exe: dir(tipo de dado/vaiavel) - dir("Alexis") ENTER
    Va aparecer uma lista de metodos que podem dar maior funcionalidade a nossa variavel:
...
help -> Apresenta a documentação/ como utilizar atributos/propriedades e funções/métodos disponiveis para detreminado
      tipo e dado ou variavel.
      estrutura: help(tipo de dado/variavel.propriedade)
      Exe: help("Alexis".lower) ENTER
